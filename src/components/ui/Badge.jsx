const PAYMENT = {
  ...
  pending:         { label: 'معلق',         cls: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/40 dark:text-yellow-400' },
}
...
const FINANCING = {
  ...
  under_review:    { label: 'تحت الدراسة',      cls: 'bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-400' },
  request_created: { label: 'إنشاء طلب',        cls: 'bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-400' },
  pending:         { label: 'معلق لدى البنك',   cls: 'bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-400' },
}
