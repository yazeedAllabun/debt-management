...
const navItems = [
  { to: '/',                  label: 'الرئيسية',    icon: LayoutDashboard, perm: 'view_dashboard' },
  { to: '/clients',           label: 'العملاء',     icon: Users,           perm: 'view_clients'   },
  { to: '/add-client',        label: 'إضافة عميل', icon: UserPlus,        perm: 'add_clients'    },
  { to: '/reports',           label: 'التقارير',    icon: FileBarChart2,   perm: 'view_reports'   },
  { to: '/calculator',        label: 'المحتسب',     icon: Calculator,      perm: null             },
  { to: '/claude-calculator', label: 'محتسب كلاود', icon: BotMessageSquare,perm: null             },
]
